...
#ifndef SEEDENGINE_INCLUDE_RUNTIME_EVENT_CORE_ENGINE_GAME_LOAD_EVENT_H_
#define SEEDENGINE_INCLUDE_RUNTIME_EVENT_CORE_ENGINE_GAME_LOAD_EVENT_H_
...
namespace seedengine {
     ...
     * @details
     */
    class ENGINE_API EngineGameLoadEvent : public EngineEvent {
