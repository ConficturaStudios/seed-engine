...
#ifndef SEEDENGINE_INCLUDE_RUNTIME_GRAPHICS_WINDOW_H_
#define SEEDENGINE_INCLUDE_RUNTIME_GRAPHICS_WINDOW_H_
...
namespace seedengine {
    ...
    class ENGINE_API Window {
        ...
        public:
            ...
            /**
             * Closes this Window. The window still must be destroyed.
             */
            void close();
            /**
             * Destroys and closes this window.
             */
            void destroy();
        ...
        protected:
            ...
            bool m_closed;
            /** True if this window has been destroyed. */
            bool m_destroyed;
        ...
        protected: // Event functions
            ...
            /**
             * Called when destroy() is called. Implementation specific.
             */
