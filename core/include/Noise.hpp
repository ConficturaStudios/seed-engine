...
namespace seedengine {
    ...
    namespace math {
        ...
        namespace noise {
            ...
            /**
             * @brief A noise generation function that takes in an x, y, z coordinate and returns
             *        a float value.
             */
            typedef float (*noise_func)(float, float, float);
            /**
             * @brief A function that modifies the value of a fractal noise function on a per-point
             *        basis. Parameters should be ordered value, x, y, z.
             */
            typedef float (*point_func)(float, float, float, float);
            /**
             * @brief A function that modifies the value of a fractal noise function on a per-octave
             *        basis. Parameters should be ordered value, x, y, z, octave, frequency, amplitude.
             */
            typedef float (*octave_func)(float, float, float, float, unsigned int, float, float);

            /**
             * @brief Generates value noise at the passed coordinate.
             * 
             * @param x The x coordinate.
             * @param y The y coordinate. Defaults to 0.
             * @param z The z coordinate. Defaults to 0.
             * @return float Computed value noise.
             */
             ...
             * @param y The y coordinate. Defaults to 0.
             * @param z The z coordinate. Defaults to 0.
             * @return float Computed perlin noise.
             */
            float perlin(float x, float y = 0, float z = 0);

            /**
             * @brief Generates simplex noise at the passed coordinate.
             * 
             * @param x The x coordinate.
             * @param y The y coordinate. Defaults to 0.
             * @param z The z coordinate. Defaults to 0.
             * @return float Computed simplex noise.
             */
            float simplex(float x, float y = 0, float z = 0);

            /**
             * @brief Generates cubic noise at the passed coordinate.
             * 
             * @param x The x coordinate.
             * @param y The y coordinate. Defaults to 0.
             * @param z The z coordinate. Defaults to 0.
             * @return float Computed cubic noise.
             */
            float cubic(float x, float y = 0, float z = 0);

            /**
             * @brief Generates white noise at the passed coordinate.
             * 
             * @param x The x coordinate.
             * @param y The y coordinate. Defaults to 0.
             * @param z The z coordinate. Defaults to 0.
             * @return float Computed white noise.
             */
            float white(float x, float y = 0, float z = 0);

            /**
             * @brief Generates cellular noise at the passed coordinate.
             * 
             * @param x The x coordinate.
             * @param y The y coordinate. Defaults to 0.
             * @param z The z coordinate. Defaults to 0.
             * @return float Computed cellular noise.
             */
            float cellular(float x, float y = 0, float z = 0);


            /**
             * @brief Computes a fractal noise value.
             * @details Computes a fractal noise value at the specified coordinate. Noise can be computed
             *          in 1, 2, or 3 dimensions, using 0 as the coordinate value for the unused dimensions.
             *          The noise function used can be specified with a function pointer and defaults to Perlin noise. 
             *
             *          Features such as frequency, amplitude, laucnarity, and gain can all be controlled, default
             *          values are provided.
             *
             ...
             * @return float The value of a fractal noise field at the specified coordinate.
             */
